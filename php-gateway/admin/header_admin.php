...
<title>Admin · EMORVIA Payment Gateway</title>
...
<aside class="sidebar">
  <div class="brand-row">
    ...
    <div class="brand-text">EMORVIA<small>Admin Panel</small></div>
  </div>
  <?php if ($adminUser): ?>
  <nav>
    ...
    <a href="payouts.php"   class="<?= $active === 'payouts.php' ? 'active' : '' ?>">Payouts</a>
